...
export default function ScenarioDashboardTopFilter({ children }: { children?: React.ReactNode }) {
  return (
    <div className="container mb-10 flex w-full flex-col gap-9 rounded-md px-4 pt-6 pb-7 sm:px-0">
      ...
      <div className="grid w-full grid-rows-2 items-end gap-6 lg:grid-cols-3 lg:grid-rows-none">
        <Suspense
          fallback={
            <>
