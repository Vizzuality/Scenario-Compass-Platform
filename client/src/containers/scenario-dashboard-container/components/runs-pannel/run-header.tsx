...
export default function RunHeader({ runs, prefix, className = "" }: Props) {
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col gap-4 rounded-lg border border-stone-600 p-4",
        className,
      )}
    >
      <Button
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center gap-2">
          <h3 className="text-lg leading-tight font-semibold text-stone-800">Selected Scenario</h3>
          <div
      ...
      <Link
        href={detailsUrl}
        target="_blank"
        className="border-primary bg-primary-foreground text-primary hover:bg-primary hover:text-primary-foreground mt-2 inline-flex w-fit items-center justify-center gap-1 rounded-md border px-3 py-1.5 text-xs font-bold transition-colors"
      >
