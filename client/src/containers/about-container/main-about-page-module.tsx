      ...
      <div className="container flex flex-col gap-10 py-24 lg:px-36 xl:px-66">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            &#34;ensemble of opportunity” of what is available, not a representative exploration of
            all possible futures. This means you cannot infer probabilities from their number or
            frequency. The Scenario Compass should be used primarily to understand the implications
            of different assumptions about the future.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            This website and the scenario ensemble are a product of the Scenario Compass Initiative
            (SCI), which brings togethers producers (modelers) and users of climate mitigation
            scenarios.
          </p>
          <p>
          ...
          <ul className="list-inside list-disc space-y-0.5">
            ...
            <li>
              <strong>Downscaling: </strong> Transforms aggregated scenario data into country level
              information (first product to be released in summer 2026)
            </li>
            <li>
