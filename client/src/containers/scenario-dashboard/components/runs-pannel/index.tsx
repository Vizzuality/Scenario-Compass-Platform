...
import NavigateToCompareScenariosButton from "@/containers/scenario-dashboard/components/buttons/navigate-to-compare-scenarios-button";
...
export default function RunsPanel({ variables }: { variables: readonly VARIABLE_TYPE[] }) {
  ...
  return (
    <div className="mx-auto flex w-120 flex-col gap-6">
      <NavigateToCompareScenariosButton />
