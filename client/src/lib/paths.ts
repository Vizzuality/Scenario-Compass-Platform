...
export const PREDEFINED_SCENARIO_DASHBOARD_PATH =
  ...
  `?${SCENARIO_DASHBOARD_MAIN_FILTER_SEARCH_PARAMS.START_YEAR}=${YEAR_OPTIONS[3]}&${SCENARIO_DASHBOARD_MAIN_FILTER_SEARCH_PARAMS.END_YEAR}=${YEAR_OPTIONS[5]}&${SCENARIO_DASHBOARD_MAIN_FILTER_SEARCH_PARAMS.GEOGRAPHY}=${geographyOptions[0].value}`;
