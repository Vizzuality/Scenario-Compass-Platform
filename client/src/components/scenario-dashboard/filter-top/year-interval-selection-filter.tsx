...
export default function YearIntervalSelectionFilter() {
  const [year, setYear] = useQueryState(SEARCH_PARAMS.YEAR);
  const [startYear, setStartYear] = useQueryState(SEARCH_PARAMS.START_YEAR);
  const [endYear, setEndYear] = useQueryState(SEARCH_PARAMS.END_YEAR);
