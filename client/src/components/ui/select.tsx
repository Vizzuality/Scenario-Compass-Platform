...
export const selectTriggerVariants = cva(
  [
    "border-input flex w-fit items-center justify-between gap-2.5 rounded-[4px] border bg-transparent p-4 text-sm leading-5 whitespace-nowrap truncate cursor-pointer outline-none",
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(selectTriggerVariants({ theme, size }), className)}
      {...props}
    >
      {children}
