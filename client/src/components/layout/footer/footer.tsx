...
import { Copyright } from "@/components/layout/footer/copywright";
      ...
      <div className={"container flex flex-col"}>
        ...
        >
          ...
          >
            ...
            >
              IIASA Data explorer <ExternalLink className={"h-4 w-4 text-stone-500"} />
            </Link>
            <Dot className="text-stone-500" />
            <div className="flex gap-9 md:gap-5">
              <Link href={"https://bsky.app/profile/iiasa.ac.at"} target="_blank">
                <BlueskyLogoIcon />
              </Link>
              <Link href={"https://at.linkedin.com/company/iiasa-vienna"} target="_blank">
