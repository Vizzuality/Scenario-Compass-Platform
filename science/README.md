...
```shell
docker exec -it iasa_notebooks /bin/bash
```
...
``` bash
mamba env create -n iasa -f environment.yml
```

This will create an environment called iasa with a common set of dependencies.
